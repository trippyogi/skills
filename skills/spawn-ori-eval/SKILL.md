...
18. Kill the run the moment a tagged elicitation, a permission request, or a tagged or untagged plain-text question appears, then continue to steps 19 to 22. If a turn contains two questions, relay only the first, report the contract violation, and continue through steps 19 to 22. If an untagged prose question appears, relay it, report the broken contract, append the answer, and restart through steps 19 to 22. Skip to step 23 if the run finishes without a question (appendix E).
